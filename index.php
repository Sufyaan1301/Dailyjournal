...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <button type="button" class="bg-dark rounded-2" id="toggle"><i
            class="bi bi-moon-stars-fill text-light "></i></button>
        <button type="button" class="bg-info rounded-2" id="tombol"><i
            class="bi bi-brightness-high-fill text-light"></i></button>
        <button type="button" class="bg-danger ms-3 text-light" id="logout"><a class="nav-link" href="logout.php"
            target="_blank"><i class="bi bi-box-arrow-right"></i></a></button>
      </div>
    </div>
  </nav>
  <!-- nav akhir -->
  ...
  <section id="gallery" class="isi text-center p-5 bg-info">
    <div class="container">
        ...
        <div id="carouselExampleIndicators" class="carousel slide display-6" data-bs-ride="carousel">
            <!-- Carousel Indicators -->
            <div class="carousel-indicators">
                ...
                ?>
                    <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="<?= $i ?>" <?= $active ?> aria-label="Slide <?= $i + 1 ?>"></button>
                <?php
                    $i++; 
                }
                ?>
            ...
            <div class="carousel-inner">
                <?php
                $hasil->data_seek(0); // Reset pointer hasil query ke awal
                $i = 0; // Reset index untuk item
                while ($row = $hasil->fetch_assoc()) {
                    $active = $i === 0 ? 'active' : ''; // Active hanya pada item pertama
                ?>
                    <div class="carousel-item <?= $active ?>">
                        <img src="img/<?= $row["gambar"] ?>" class="d-block w-100" alt="...">
                    </div>
                <?php
                    $i++; // Increment untuk slide berikutnya
                }
                ?>
            </div>
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="gambar col-3" id="gambar">
          <img src="https://th.bing.com/th/id/OIP.R5MXRG_UYRmQSnzQKdaxYQHaIn?rs=1&pid=ImgDetMain"
            class="gambar img-fluid rounded-circle" width="300">
        </div>
