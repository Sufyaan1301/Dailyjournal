...
<body>
    <!-- nav begin -->
    <nav class="navbar navbar-expand-sm bg sticky-top bg-info">
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item nav-item nav-link" href="admin.php?page=profil">Profile 
                        <?= $_SESSION['username']?>
                    </a></li>
...
<!-- content end -->
    ...
    <div>Sufyaan Adil Rusydi @2024</div>
    </footer>
    <!-- footer end -->
    <script
